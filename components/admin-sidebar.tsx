...
export function AdminSidebar() {
  ...
  useEffect(() => { fetch("/api/admin/summary", { cache: "no-store" }).then((response) => response.ok ? response.json() as Promise<{ pendingBookings: number }> : Promise.reject()).then((result) => setPendingBookings(result.pendingBookings)).catch(() => undefined); }, []);
