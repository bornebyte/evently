...
import { ArrowLeft, ArrowRight, ArrowUpRight, CalendarDays, ChevronDown, Clock3, CreditCard, Heart, MapPin, Mail, Minus, Plus, QrCode, Share2, ShieldCheck, Users } from "@/components/icons";
...
export default function EventDetails({ event, related }: { event: PublicEvent; related: PublicEvent[] }) {
  ...
  const mapHref = event.latitude !== null && event.longitude !== null ? `https://www.google.com/maps/search/?api=1&query=${event.latitude},${event.longitude}` : `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${event.address}, ${event.city}, ${event.country}`)}`;
