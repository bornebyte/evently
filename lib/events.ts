...
export const events: EventItem[] = [
  {
    ...
    sold: 612,
    ticketTiers: [
      { name: "General admission", description: "Full day access + lunch", price: 42, remaining: 188, total: 500, accent: "#202321" },
      { name: "Front row", description: "Priority seating + dinner", price: 78, remaining: 42, total: 150, accent: "#f16d55" },
      { name: "Student", description: "Valid student ID required", price: 24, remaining: 28, total: 150, accent: "#8b779f" },
    ],
  },
  {
    ...
    sold: 948,
    ticketTiers: [
      { name: "Early bird", description: "Entry before 10 PM", price: 18, remaining: 31, total: 400, accent: "#202321" },
      { name: "Standard", description: "All-night entry", price: 24, remaining: 252, total: 650, accent: "#f16d55" },
    ],
  },
  {
    ...
    sold: 168,
    ticketTiers: [
      { name: "A seat at the table", description: "Five course lunch + welcome drink", price: 65, remaining: 52, total: 220, accent: "#f16d55" },
    ],
  },
  {
    ...
    sold: 92,
    ticketTiers: [
      { name: "Slow Sunday pass", description: "Workshop + breakfast", price: 28, remaining: 48, total: 140, accent: "#8aa17e" },
    ],
  },
  {
    slug: "kinetic-light",
    ...
    sold: 640,
    ticketTiers: [
      { name: "Timed entry", description: "One-hour arrival window", price: 22, remaining: 260, total: 900, accent: "#536f84" },
    ],
  },
  {
    ...
    sold: 1210,
    ticketTiers: [
      { name: "Advance", description: "Entry all night", price: 16, remaining: 182, total: 500, accent: "#202321" },
      { name: "On the door", description: "Subject to availability", price: 22, remaining: 108, total: 1000, accent: "#f16d55" },
    ],
  },
];
